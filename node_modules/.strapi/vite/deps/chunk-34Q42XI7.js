...
} from "./chunk-J62B6TNG.js";
import {
  QueryClient,
  QueryClientProvider,
  img
} from "./chunk-BVXDAAPE.js";
import {
  ADMIN_PERMISSIONS_CE,
  HOOKS
} from "./chunk-OPJIE3PT.js";
import {
  GuidedTourProvider,
  useGuidedTour
} from "./chunk-IO7WZXN5.js";
import {
  require_pick
} from "./chunk-NPJV7MCV.js";
import {
  useEnterprise
} from "./chunk-J32ZC32O.js";
import {
  Login
} from "./chunk-N6CKFTRI.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-TLON6ZXH.js";
import {
  ConfigurationProvider
} from "./chunk-KVASKHHF.js";
import {
  require_baseMerge,
  require_createAssigner,
  require_merge,
  require_omit
} from "./chunk-Y26KBYKO.js";
import {
  require_baseRest
} from "./chunk-5AHGP3NF.js";
import {
  HistoryProvider
} from "./chunk-2V4TVC42.js";
import {
  errorsTrads
...
import {
  ...
  create4 as create2,
  create6 as create3
} from "./chunk-VDFH3VRI.js";
import {
  TrackingProvider,
  useTracking
} from "./chunk-JY3JCPOU.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-IQOS4JWV.js";
import {
  getBasename
} from "./chunk-QIJGNK42.js";
import {
  useClipboard
} from "./chunk-NHQZDJKQ.js";
import {
  ADMIN_PERMISSIONS_EE,
  getEERoutes
} from "./chunk-C4VKJH6J.js";
import {
  MemoizedInputRenderer
} from "./chunk-KLQ3KW2Y.js";
import {
  Form
} from "./chunk-RDRH5OMA.js";
import {
  Layouts
} from "./chunk-MQB2PZ66.js";
import {
  getByteSize
...
} from "./chunk-VPFBEJKJ.js";
import {
  useTypedDispatch,
  useTypedSelector,
  useTypedStore
} from "./chunk-QYQOFA43.js";
import {
  adminApi,
  getFetchClient,
  isBaseQueryError,
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-ICV6ROLT.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-ZMOYQCPH.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-LL7D3DAJ.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-STE2DUGA.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-SN2AF3O3.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-YJVV23SM.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-B6PP5QSV.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-SUYDYJCH.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-YSSVQBNI.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-MQH2OVL5.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-YGHH55JO.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-4GYNIZJZ.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-JZA2OUQX.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-OJVGDJ24.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-AWZ32HCG.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-YLHMU4KP.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-TF2RTVBJ.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-YPBESAPO.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-3PB4LIMX.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-LKDUHOJG.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-CJDEHQQQ.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-NIQHH4SS.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-NYY3QBBF.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-DUH7TSSE.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-K546NUYG.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-EJG4VAWT.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-433Z2E3C.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-BM2CPTV3.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-XSZS7S2P.js");
              return {
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    ...
    case "./translations/en.json":
      return import("./en.json-EDF56CPT.js");
...
function __variableDynamicImportRuntime0__(path) {
  switch (path) {
    case "./translations/en-GB.js":
      return import("./en-GB-YRN4GBLM.js");
    default:
      return new Promise(function(resolve, reject) {
        (typeof queueMicrotask === "function" ? queueMicrotask : setTimeout)(
          reject.bind(null, new Error("Unknown variable dynamic import: " + path))
...
//# sourceMappingURL=chunk-34Q42XI7.js.map
