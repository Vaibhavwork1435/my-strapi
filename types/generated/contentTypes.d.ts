...
export interface ApiSingleTextSingleText extends Struct.SingleTypeSchema {
  collectionName: 'single_texts';
  info: {
    displayName: 'SINGLE_TEXT';
    pluralName: 'single-texts';
    singularName: 'single-text';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::single-text.single-text'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    SKILL_MATRIX: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::single-text.single-text': ApiSingleTextSingleText;
